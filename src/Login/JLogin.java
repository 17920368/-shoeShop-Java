...
import usuarios.operacionesusuarios;
...
public class JLogin extends javax.swing.JFrame {
    ...
    public void validarusuarios() {
        String salidaArchivo = "usuarios.txt"; // Nombre del archivo
...
//
    ...
    public void add() {
        ...
        em.setId(1);
        em.setUsuario("Julian");
        em.setPass("julian");
        em.setTipo("Administrador");
    ...
    private void initComponents() {
        ...
        cbotipo.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        ...
        contra.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        ...
        txtusuario.setFont(new java.awt.Font("DialogInput", 1, 14)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(contra, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 149, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tipousuario = (String) cbotipo.getSelectedItem();
        String user = this.txtusuario.getText();
        String pass = this.contra.getText();
        if (oper.validarDatos("usuarios.txt", user, pass, tipousuario)) {
            this.dispose();
        } //        if (this.oper.buscar("empleados.txt", tipousuario, pass)) {
    ...
    private void cbotipoItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cbotipoItemStateChanged
        // TODO add your handling code here:
        int pos = this.cbotipo.getSelectedIndex();
        if (pos == 0) {
